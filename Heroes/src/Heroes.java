...
public class Heroes {
    public static void startHeroesGame(SLL<Card> firstFriendCards, SLL<Card> secondFriendCards) {
        SLLNode<Card>temp=firstFriendCards.getFirst();
        SLLNode<Card> best=temp;
        while(temp!=null)
        {
            if((best.element.damage())<(temp.element.damage()))
            {
                best=temp;
            }
            temp=temp.succ;
        ...
        Card deleted=firstFriendCards.delete(best);
        secondFriendCards.insertAfter(best.element, secondFriendCards.getFirst().succ.succ);
